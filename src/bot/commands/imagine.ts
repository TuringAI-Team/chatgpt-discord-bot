    ...
    options: [
			...
			},*/
      {
        ...
        choices: [
          ...
          [
            "Fustercluck (Cartoon) · SDXL model trained for creating cartoony style images",
            "c-fustercluck",
          ],
          [
            "Fustercluck (Anime) · SDXL model trained for creating cartoony style images",
            "a-fustercluck",
          ],
            ...
            embeds: [
              {
                ...
                title: "Error",
                description:
                  "The image was censorred cause it violates our filter rules.",
              },
            ],
          });
          return;
