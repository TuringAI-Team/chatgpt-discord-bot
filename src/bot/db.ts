...
import { CollectionName } from "../types/collections.js";
...
export async function env(guildId: string, userId: string) {}

export async function premium(guildId: string, userId: string) {}
